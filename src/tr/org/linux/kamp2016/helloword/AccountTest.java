package tr.org.linux.kamp2016.helloword;
...
public class AccountTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(account1.getName() + " " + "'in bikayesi: "
				+ account1.getBalance());

		Scanner input = new Scanner(System.in);//Ctrl+Shif+O ile eksik kütüphaneler eklendi
